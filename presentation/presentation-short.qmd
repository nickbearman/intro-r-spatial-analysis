...
subtitle: "Sun 30th August 2026 | 2pm - 5pm (Japan)"
...
While we wait, please check the website:
...
-   Introductions
    ...
    -   Have you done any R before? (no is fine!)
    -   What would you like from the course?
...
-   Presentations, handouts and data on web
...
-   **Day 1** - Session 1: Introduction to R and Spatial Data Basics
    -   2:00pm - 2:45pm -- What is GIS & R?
    -   2:45pm - 3:30pm -- Practical 1: Intro to R & GIS
    -   *3:30pm - 3:45pm -- break*
-   **Day 1** Session 2: Classification and Creating a Choropleth Map
    -   3:45pm - 4:05pm -- Classification
    -   4:05pm - 5:00pm -- Practical 2: Making a Map
-   Day 2 - Session 3: Map Customisation and Automation in R
    -   2:00pm - 2:20pm -- Recap and Making Maps
    -   2:20pm - 3:30pm -- Practical 3: Clustering of Crime Points
    -   *3:30pm - 3:45pm -- break*
-   Day 2 - Session 4: Clustering Crime Points and Working with Your Own Data
    -   3:45pm - 5:00pm -- Practical 4: Bring Your Own Data
-->
<!--
...
- 2:00pm – 2:30pm – What is GIS & R?
- 2:30pm - 3:15pm – Practical: Intro to GIS & R
- 3:15pm - 3:35pm - Classification
- 3:35pm - 4:00pm - Practical: Making a Map
- 4:00pm - 5:00pm - Demo & Practical: Loops for Automated Map Production
...
::: {.fragment}
  ...
  - LLM / ChatGPT / assistant
    ...
    - [Posit AI in RStudio - subscription](https://posit.co/blog/introducing-ai-in-rstudio/)
    - [Generative AI Tools for Quantitative Research: A Practical Guide, David Bann and Liam Wright - PAYG Positron Claude](https://repository.ncrm.ac.uk/resources/online/all/ai_tools_quantitative_research)
:::
...
-   R is increasingly popular in the academic and commercial (data-science) sector | Positron also an option
...
- I will walk around and see how people are getting on
- Hand up if you have a question
- Breaks
...
- What are those classes? What colour scheme would you use? Why?
- Share your link / URL from ColorBrewer in the chat.
...
-   Be creative
-   Try the different options in the practical
...
- I will talk through the loop code
- Up to you if you follow along with me
- Or have a look at it afterwards
...
## Loops for Multiple Maps

- Troubleshooting tips - step through loop
...
## Training Courses - PR Stats

- [Introduction to Spatial Data and Using R as a GIS](https://prstats.org/course/introduction-to-spatial-data-analysis-and-gis-workflows-in-r-irgi01/)
  - Tue 17th and Wed 18th Nov 2026, 2pm - 5pm (UK/London), online, PR Stats
  - Understand how to use loops to make multiple maps
  - Know how to reproject spatial data
  - Be able to perform point in polygon operation

## Training Courses - PR Stats

- [Advanced Spatial Analysis Workflows in R](https://prstats.org/course/advanced-r-for-spatial-analysis-argi01/)
  - Tue 24th and Wed 25th Nov 2026, 2pm - 5pm (UK/London), online, PR Stats
...
- `sp` is a much older spatial library (depreciated end 2023)
...
- Example in `\script-examples\script-SP-single-map.R`
...
- David O'Sullivan [tmap vs. ggplot2 for Mapping](https://geospatialstuff.com/posts/2024/11/16/tmap-vs-ggplot/index.html)
...
- We have covered a lot over the last 4 sessions
...
-   Lots of free tutorials available online
-   GIS Training Courses -   [www.nickbearman.com](https://www.nickbearman.com)
- [Advanced R as a GIS: Spatial Analysis](https://www.ncrm.ac.uk/training/show.php?article=14377)
