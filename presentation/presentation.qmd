...
subtitle: "Day 1 | Tue 27th May 2025 | 10am - 1pm"
...
![](images/instats-download.png)

- Slides - slides for session 1 ;-)
- Program Files - `script-examples.zip`
- Readings - `glossary.pdf`
- Workbook - `workbook.pdf` & `workbook.html`
-->
