...
date: "Tue 18th and Wed 19th August 2026"
---
...
You can also show a histogram with the classification breaks using this code. *This needs the `ggplot2` library installed to work.*
...
As I mentioned in the presentation, there is a `sp` library for R, an older library, which handles spatial data in a different way. See the presentation for details, and there is an example file in `\script-examples` called `script-SP-single-map.R` to show you how `sp` works. 
...
This practical was written using R 4.5.3 (2026-03-11), RStudio 2026.01.1+403 and `tmap` 4.2, last updated on 14/07/2026 by Dr. Nick Bearman (nick@nickbearman.com). It has also been tested in Posit Cloud, with R 4.5.3 (2026-03-11), RStudio 2026.01.1+403 and `tmap` 4.2. 
