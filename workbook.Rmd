...
| Be able to perform point in polygon analysis  | `poly.counts()` (pg. 18)  | 
...
```{r, error=FALSE, message=FALSE, warning=FALSE, comment=NA, results='hide'}
#load libraries
