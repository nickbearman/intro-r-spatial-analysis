...
| Customize colour & classifications (pg. 11)  | `classIntervals()` (pg. 11)  | 
| Understand how to use loops for multiple maps (pg. 12) | `for(){}` (pg. 12)  | 
| Know how to reproject spatial data (pg. 14) | `spTransform()` (pg. 14)  | 
| Be able to perform point in polygon (pg. 15) | `gContains()` (pg. 15)  | 
| Know how to write shape files (pg. 17) | `writeOGR()` (pg. 17)  | 
| Know how create a 'heat-map' (pg. 17) |  `spatstat` librar (pg. 17)  | 
