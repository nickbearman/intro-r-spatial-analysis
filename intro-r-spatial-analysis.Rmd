...
plot(sthel.prices, col = my_colours[findInterval(var, breaks$brk, all.inside = TRUE)],
...
my_colours <- brewer.pal(6, "Greens")
#plot map
plot(LSOAs, col = my_colours[findInterval(var, breaks$brks, all.inside = TRUE)], axes = FALSE, 
...
pdf(file="image.pdf")
  ...
  breaks <- classIntervals(var, n = 6, style = "fisher")
  my_colours <- brewer.pal(6, "Greens")
  plot(LSOAs, col = my_colours[findInterval(var, breaks$brks, all.inside = TRUE)],   
       axes = FALSE, border = rgb(0.8,0.8,0.8))
