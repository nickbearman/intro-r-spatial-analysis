...
Know how to write shape files (pg. 16) | `writeOGR()` (pg. 16)
...
```{r getdata}
hp.data <- read.csv("http://nickbearman.me.uk/data/20151002-liv/hpdata.csv")
```
...
```{r, comment=NA}
download.file("http://www.nickbearman.me.uk/data/20151002-liv/sthel.zip","sthel.zip")
unzip("sthel.zip")
```
...
```{r, echo=FALSE, comment=NA}
download.file("http://www.nickbearman.me.uk/data/20151002-liv/KS102EW_2596_2011SOA_NW.csv","KS102EW_2596_2011SOA_NW.csv")
```
...
```{r, echo=FALSE, comment=NA}
download.file("http://www.nickbearman.me.uk/data/20151002-liv/england_lsoa_2011Polygon.zip","england_lsoa_2011Polygon.zip")
...
crimes <- read.csv("http://nickbearman.me.uk/data/20151002-liv/police-uk-2014-04-merseyside-street.csv")
```
...
```{r, comment=NA}
#download file
download.file("http://www.nickbearman.me.uk/data/20151002-liv/merseyside_outline.zip",
